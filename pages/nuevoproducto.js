...
const NuevoProducto = () => {
    ...
    const[nuevoProducto]=useMutation(NUEVO_PRODUCTO,{
        update(cache,{data:{nuevoProducto}}){
            ...
            const{obtenerProductos}=cache.readQuery({query:OBTENER_PRODUCTS});
            //rewrite
            cache.writeQuery({
    ...
    return ( 
        <Layout>
        <h1 className="text-2xl text-gray-800 font-light animate__animated animate__fadeIn animate__delay-1s">Crear nuevo producto</h1>
