...
const NuevoCliente = () => {
    ...
    const formik=useFormik({
        ...
        onSubmit:async valores=>{
            ...
            try {
                ...
                console.log(error);
                // MostrarMensaje(error.message.replace('G'))
    ...
    return ( 
        <Layout>
            <h1  className="text-2xl text-gray-800 font-light animate__animated animate__fadeIn animate__delay-1s">Nuevo cliente</h1>
